...
var Elm = {};
Elm['Synthesizer'] = Elm['Synthesizer'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Synthesizer'], 'Synthesizer', typeof _user$project$Synthesizer$main === 'undefined' ? null : _user$project$Synthesizer$main);
